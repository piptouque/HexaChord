...
public class SquareGridCoordList extends ArrayList<int[]>{
	...
	// La structure retournée est l'ensemble résultant de mappings sur les coordonnées
...
//		}
	...
	public ArrayList<ArrayList<int[]>> get_edges() {
		...
		for (int[] i : this){
			...
			for (int[] i2 : this){
				if(Arrays.equals(note_coord2, i2) || Arrays.equals(note_coord3, i2) || Arrays.equals(note_coord4, i2)){
