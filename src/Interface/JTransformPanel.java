...
import java.awt.RenderingHints;import java.awt.event.ComponentEvent;
...
public class JTransformPanel extends JComponent implements MouseInputListener, MouseWheelListener,  KeyListener, ComponentListener {
...
//    }
    ...
    private void on_transformation() {
        ...
        while(layer.hasNext()) layer.next().on_transformation();
        repaint();
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (Parameters.getInstance().is_musification()){
        	on_transformation();		// CommentŽe car a fait boucler le programme        	
        }
    ...
    public void mouseDragged(MouseEvent evt) {
        ...
        if (((modifiers & InputEvent.BUTTON3_MASK) == InputEvent.BUTTON3_MASK) || ((modifiers & InputEvent.CTRL_MASK) == InputEvent.CTRL_MASK) )
            rotate((float)Math.atan2(_mouseY-_h_2,_mouseX-_w_2) - (float)Math.atan2(evt.getY()-_h_2,evt.getX()-_w_2));
        else
    ...
    public void keyPressed(KeyEvent evt) {
        ...
        case KeyEvent.VK_DOWN:   translate(0,10);  break;
        case KeyEvent.VK_UP:     translate(0,-10); break;
