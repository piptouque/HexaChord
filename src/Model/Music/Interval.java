...
public abstract class Interval {
	...
	public static String get_name(int i, char language) {
		...
		if (language == 'F') {
			...
			case 0:
				return "Unison";
			case 1:
				return "Seconde mineure";
			case 2:
				return "Seconde majeure";
			case 3:
			...
			case 5:
				return "Quarte juste";
			case 6:
				return "Quarte augumente";
			case 7:
				return "Quinte juste";
			case 8:
				return "Sixte mineure";
			case 9:
				return "Sixte majeure";
			case 10:
				return "Septime mineure";
			case 11:
				return "Septime majeure";
			default:
				return "??";
			}
		}
	...
	public static int distance_in_fith_circle(int n1, int n2) {
		...
		for (int i = 0; i < fifth_list.size(); i++) {
			if (fifth_list.get((index1 + i) % fifth_list.size()) == n2
					|| fifth_list.get((index1 - i + fifth_list.size()) % fifth_list.size()) == n2)
				return i;
		}
