...
public class LineDiagram extends Diagram {
	...
	public void build_chart(String x_axis, String y_axis, boolean draw_shapes) {
		_chart = ChartFactory.createXYLineChart(_name, x_axis, y_axis, _dataset, PlotOrientation.VERTICAL, true, true,
				false);
	...
	public void display_area_diagram() {
		JFreeChart chart = ChartFactory.createXYAreaChart(_name, "time", "tonnetz compliance", _dataset,
