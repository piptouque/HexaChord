...
public class BarDiagram extends Diagram{
	...
	public void display_bar_diagram(String compactness) {
		...
		_chart = ChartFactory.createBarChart(
				_name, "",compactness,_dataset,PlotOrientation.VERTICAL, LEGEND, true,false );
//		
...
//		position = new ItemLabelPosition(position.getItemLabelAnchor(), position.getTextAnchor(), position.getRotationAnchor(), 1);
...
//		renderer.setBaseItemLabelFont(new Font("Serif", Font.PLAIN, 80));
		...
		// create the chart... 
//		JFreeChart chart = ChartFactory.createBarChart("Item Label Demo 1", "Category", "Value", _dataset, PlotOrientation.VERTICAL, false,true, false);
...
//		rangeAxis.setStandardTickUnits(units);
		...
		//rangeAxis.setStandardTickUnits(NumberAxis.createIntegerTickUnits());  // N'affiche que les entier sur l'axs des ordonn�es
		...
		if (_black_and_white) set_renderer_BW(renderer);
		//renderer.setItemMargin(-6);
		renderer.setGradientPaintTransformer(null);

		if (LEGEND) renderer.setItemMargin(0.0);
        ...
        _chartFrame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE); // lib�re la m�moire lorsque la fen�tre est ferm�e
	...
	private static void set_renderer_BW(BarRenderer renderer){
		...
		// diag 1
//	    BufferedImage bufferedImage0 = new BufferedImage(5,5,BufferedImage.TYPE_INT_RGB);
...
//	    // diag 2
//	    BufferedImage bufferedImage1 = new BufferedImage(5,5,BufferedImage.TYPE_INT_RGB);
...
//
//	    // horizontal
//	    BufferedImage bufferedImage2 = new BufferedImage(5,5,BufferedImage.TYPE_INT_RGB);
...
//
//	    // vertical
//	    BufferedImage bufferedImage3 = new BufferedImage(5,5,BufferedImage.TYPE_INT_RGB);
